        ...
        <div className="relative">
          ...
          {education.map((edu, index) => (
            ...
            >
              ...
              {/* Timeline Icon */}
              <div className="relative z-10 bg-cyan-500/20 backdrop-blur-md rounded-full p-3 border border-cyan-400/30 mb-4 md:mb-0 md:absolute md:left-1/2 md:transform md:-translate-x-1/2">
